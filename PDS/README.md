...
- **P2 — Spectral Analysis with the DFT**: windowing, spectral resolution and leakage.
- **P3 — Digital Filter Design**: FIR vs IIR design against templates, group-delay study, noise and phase case studies.
- **P4 — Fast Convolution**: block-based processing and the overlap-save algorithm for long/real-time signals.
